...
db.regProvincies.hasMany(db.regRegencies, { as: "province", foreignKey: "province_id" });
db.regRegencies.belongsTo(db.regProvincies, { as: "province", foreignKey: "province_id" });
...
db.regRegencies.hasMany(db.company, { as: "city", foreignKey: "fid_regencies" });
db.company.belongsTo(db.regRegencies, { as: "city", foreignKey: "fid_regencies" });
db.masterIndustry.hasMany(db.company, { as: "industry", foreignKey: "fid_industry" });
db.company.belongsTo(db.masterIndustry, { as: "industry", foreignKey: "fid_industry" });
db.user.hasMany(db.company, { foreignKey: "fid_user" });
db.company.belongsTo(db.user, { foreignKey: "fid_user" });
db.masterCompanyStatus.hasMany(db.company, { as: "status", foreignKey: "fid_company_status" });
db.company.belongsTo(db.masterCompanyStatus, { as: "status", foreignKey: "fid_company_status" });
...
db.eventsTicketing.belongsTo(db.events, { foreignKey: "fid_events" });
db.regRegencies.hasMany(db.events, { as: "event_city", foreignKey: "fid_regencies" });
db.events.belongsTo(db.regRegencies, { as: "event_city", foreignKey: "fid_regencies" });
db.user.hasMany(db.events, { foreignKey: "fid_user" });
db.events.belongsTo(db.user, { foreignKey: "fid_user" });
db.masterEvent.hasMany(db.events, { as: 'event_type', foreignKey: "fid_type" });
db.events.belongsTo(db.masterEvent, { as: 'event_type', foreignKey: "fid_type" });
